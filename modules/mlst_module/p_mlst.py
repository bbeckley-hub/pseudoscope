...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .ascii-art {{
            ...
            isplay: inline-block;  /* allows centering */
            text-align: left;       /* keeps the pre text left-aligned */
        }}
        .quote-container {{
    ...
    <script>
        // Rotate quotes (simple, could be enhanced)
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PseudoScope MLST Batch Summary</title>
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        body {{
            background: linear-gradient(135deg, #2c0b0e 0%, #4a1c20 50%, #6b2b2f 100%);
